...
<!-- --------------------------------------------- PROFILE INFO -------------------------------------------------------------- -->
  ...
  <div class="item">
    <div class="ui medium circular image">
      <img src="images/nurse-default.png">
    </div>
      ...
      <div class="extra">
              ...
              <div class="description">
                ...
                <div class="rightpart">
                      ...
                      <br><i class="calendar icon"></i>Register Date: &nbsp; <?php echo $regDate; ?> </br>
                      <br><i class="treatment icon"></i>Position: &nbsp; <?php echo $position; ?> </br>
                  </p>
                </font>
                </div>
...
<form method="GET" action="edit-nurse.php">
    <?php echo '<input type="hidden" name="editID" value="'.$id.'" />'; ?>
    <input type="submit" class="ui right floated green button" value="Edit Information" />
</form>
